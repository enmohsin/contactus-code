...
class Contact{
    ...
    public function contact_us($data){
       ...
       if($data==true){
           $body="One message received from msoft contact us. details are below..<br> first_name='$fname', last_name='$lname', email='$email', phone='$phone', message='$message'";
           return $this->sent_mail("info@msoft.com", "Message received from msoft", $body);
       }
    }
    
    public function sent_mail($to,$subject,$body){
$mailFromName="msoft";
$mailFrom="info@msoft.com";
/////////////////////////////////////////////////////////////
//Mail Header
